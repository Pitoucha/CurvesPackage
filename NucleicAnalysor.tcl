...
##
## Id: NucleicAnalysor.tcl, v1.0 2021/06/10 16:03
##
##analyse et visualisation

package provide NucleicAnalysor 0.1
package require Tk
...
namespace eval ::nucleicanalysor:: {
  namespace export nucleicanalysor
  ...
  variable NUCLEICANALYSOR_PATH $env(NUCLEICANALYSOR_PATH)
  variable PACKAGE_PATH "$NUCLEICANALYSOR_PATH"
  variable PACKAGEPATH "$NUCLEICANALYSOR_PATH"
}


proc ::nucleicanalysor::packageui {} {
  variable w
  ...
  $w.menubar.edit.menu add command -label "Load new Mol" -command ::nucleicanalysor::chargement
  $w.menubar.edit.menu add command -label "Load new trajectory" -command ::nucleicanalysor::trajectLoad
  #$w.menubar.edit.menu add command -label "test exec ls" -command ::nucleicanalysor::testLs
  #$w.menubar.edit.menu add command -label "GNUplot" -command ::nucleicanalysor::gnuPlotTest
  
  menubutton $w.menubar.help -text Help -underline 0 -menu $w.menubar.help.menu
  menu $w.menubar.help.menu -tearoff no

  $w.menubar.help.menu add command -label "Help" -command ::nucleicanalysor::callHelp
  ...
  grid $w.menubar.help -row 0 -column 2 -sticky ew
...
proc ::nucleicanalysor::callHelp {} {
  set location [pwd]
  variable NUCLEICANALYSOR_PATH
  cd $NUCLEICANALYSOR_PATH
  ...
  if {[catch {exec {*}$command "help/index.html" &} error]} {
    return -code error "couldn't execute '$command': $error"
  }
  cd $location
}

proc ::nucleicanalysor::Histograms {type} {
  variable w 
  ...
  switch $type {
    dist {
      if {$base1 != "" && $idBase1 != "" && $match1 != "" && $idMatch1 != "" && $base2 == "" && $idBase2 == "" && $match2 == "" && $idMatch2 == "" } {
        ...
        set listP [::nucleicanalysor::plotBases dist 1]
        for { set i 0 } { $i <= [llength $listP] } { incr i } {
          puts $file [lindex $listP $i]
        }
        close $file
        ::nucleicanalysor::gnuPlotting $name "distVar_$base1\($idBase1\)_$match1\($idMatch1\)" "Distance in Angstrom" 
          ...
          if {$base2 != ""} {
            ...
            close $file1
            ::nucleicanalysor::gnuPlotting $name1 "distVar_$base1\($idBase1\)_$match1\($idMatch1\)" "Distance in Angstrom" 
            ...
            close $file2
            ::nucleicanalysor::gnuPlotting $name2 "distVar_$base2\($idBase2\)_$match2\($idMatch2\)" "Distance in Angstrom" 
          }
        }
    }
    angl {
      if {$base1 != "" && $idBase1 != "" && $match1 != "" && $idMatch1 != "" && $base2 == "" && $idBase2 == "" && $match2 == "" && $idMatch2 == ""} {
        ...
        set file [open $name w]
        set listP [::nucleicanalysor::plotBases angl 1]
        for { set i 0 } { $i <= [llength $listP] } { incr i } {
          puts $file [lindex $listP $i]
        }
        close $file
        ::nucleicanalysor::gnuPlotting $name "anglVar_$base1\($idBase1\)_$match1\($idMatch1\)" "Angle in °" 
      } elseif {$base1 != "" && $idBase1 != "" && $match1 != "" && $idMatch1 != "" && $base2 != "" && $idBase2 != "" && $match2 != "" && $idMatch2 != ""} {
          set listP [::nucleicanalysor::plotBases angl 1]
          if {$base2 != ""} {
            set list1 [lindex $listP 0]
            ...
            close $file1
            ::nucleicanalysor::gnuPlotting $name1 "anglVar_$base1\($idBase1\)_$match1\($idMatch1\)" "Angle in °" 
            ...
            close $file2
            ::nucleicanalysor::gnuPlotting $name2 "anglVar_$base2\($idBase2\)_$match2\($idMatch2\)" "Angle in °" 
        }
      }
    }
    4dist {
      if {$base1 != "" && $idBase1 != "" && $match1 != "" && $idMatch1 != ""} {
        ...
        set file [open $name w]
        set listP [::nucleicanalysor::plotBases 4dist 1]
        for { set i 0 } { $i <= [llength $listP] } { incr i } {
          puts $file [lindex $listP $i]
        }
        close $file
        ::nucleicanalysor::gnuPlotting $name "distVar_$base1\($idBase1\)-$match1\($idMatch1\)_$base2\($idBase2\)-$match2\($idMatch2\)" "Distance in Angstrom" 
      }
    }
    4angl {
      if {$base1 != "" && $idBase1 != "" && $match1 != "" && $idMatch1 != ""} {
        ...
        set file [open $name w]
        set listP [::nucleicanalysor::plotBases 4angl 1]
        for { set i 0 } { $i <= [llength $listP] } { incr i } {
        puts $file [lindex $listP $i]
      }
      close $file
      ::nucleicanalysor::gnuPlotting $name "anglVar_$base1\($idBase1\)-$match1\($idMatch1\)_$base2\($idBase2\)-$match2\(idMatch2\)" "Angle in °" 
    }
  }
    default {
...
proc ::nucleicanalysor::gnuPlotting {nameDat name type} {
  set path [pwd]
  append path "/" 
  append path $nameDat 
  ...
  set rounding [::nucleicanalysor::callRoundingChooser]
...
proc ::nucleicanalysor::callRoundingChooser {} {
...
#load a new molecule
proc ::nucleicanalysor::chargement {} {
  variable w
  variable plotColors
  ...
  if {$newMol != ""} {
    ...
    grid [button $w.nb.tab1.helix.btnMatch -text "Match these resId to get the facing resId" -command "::nucleicanalysor::matchList"] -row 1 -columnspan 2
    ...
    #plotting buttons
    grid [button $w.nb.tab1.helix.distSel -text "Plot the distance variation between these two bases" -command "::nucleicanalysor::plotBases {dist}"] -row 3 -columnspan 2
    grid [button $w.nb.tab1.helix.angVal -text "Plot the angle variation between these two bases" -command "::nucleicanalysor::plotBases {angl}"] -row 4 -columnspan 2
    grid [button $w.nb.tab1.helix.distVal -text "Plot the distance between the two pairs of bases " -command "::nucleicanalysor::plotBases {4dist}" -state disabled] -row 5 -column 0
    ...
    grid [button $w.nb.tab1.helix.angleVal -text "Plot the angle between the two pairs of bases " -command "::nucleicanalysor::plotBases {4angl}" -state disabled] -row 6 -column 0
    ...
    grid [button $w.nb.tab2.gQuad.oneQua.planGuaAxis -text "Planarity of the guanines compared to the quartets' perpendicular axis" -command "nucleicanalysor::guaPlanForQuaAxis"] -row 0 -column 0
    grid [labelframe $w.nb.tab2.gQuad.oneQua.selGua -text "Which quartet's guanines ?"] -row 0 -column 1 -rowspan 5
    grid [entry $w.nb.tab2.gQuad.oneQua.selGua.quaSel -textvar ::nucleicanalysor::quaNum]
    
    # Calculating the guanines' planarity between themselves
    grid [button $w.nb.tab2.gQuad.oneQua.planGua -text "Planarity of the guanins compared to each other" -command "nucleicanalysor::guaPlan"] -row 1 -column 0
    
    # Calculating the quartet bending lengthwise
    grid [button $w.nb.tab2.gQuad.oneQua.lenBendB -text "Lengthwise quartet bending" -command "nucleicanalysor::lenBend"] -row 2 -column 0
    
    # Calculating the angle between the guanines' axis
    grid [button $w.nb.tab2.gQuad.oneQua.guaAngles -text "Angles between the guanins' axis of the selected quartet" -command "nucleicanalysor::guaAxisAngle"] -row 3 -column 0
    
    # Calculating the distance between the COMs of O6 and N9 squares on a quartet
    grid [button $w.nb.tab2.gQuad.oneQua.quaCom -text "Distance between CoM(O6) and CoM(N9)" -command "nucleicanalysor::comO6N9"] -row 4 -column 0
    
    # Calculating the twist angles
    grid [labelframe $w.nb.tab2.gQuad.noQua] -row 2 -columnspan 2
    grid [button $w.nb.tab2.gQuad.noQua.twist -text "Twist angles" -command "nucleicanalysor::twistAngle"] -row 0
    
    # Calculating the gyration radii
    grid [button $w.nb.tab2.gQuad.noQua.gyr -text "Gyration radii" -command "nucleicanalysor::gyrationRadii"] -row 1
    ...
    grid [button $w.nb.tab2.gQuad.twoQua.comDistancesGua -text "Distances between guanines and multiple centers of mass" -command "nucleicanalysor::guaCoMDistances"] -row 0 -column 0
    ...
    grid [entry $w.nb.tab2.gQuad.twoQua.selQua.main -textvar ::nucleicanalysor::mainQua] -row 0 -column 1
    ...
    grid [entry $w.nb.tab2.gQuad.twoQua.selQua.sec -textvar ::nucleicanalysor::secQua] -row 1 -column 1
    
    # Calculating the distance between the CoM of the quartets
    grid [button $w.nb.tab2.gQuad.twoQua.comDistances -text "Distance between the CoM of the quartets" -command "nucleicanalysor::comQua"] -row 1 -column 0
    ...
    grid [entry $w.frames.frameStart -textvar ::nucleicanalysor::frameStart] -row 7 -column 1
    grid [label $w.frames.frameELab -text "Last frame :"] -row 7 -column 2
    grid [entry $w.frames.frameEnd -textvar ::nucleicanalysor::frameEnd] -row 7 -column 3
    grid [label $w.frames.stepLab -text "Step :"] -row 7 -column 4
    grid [entry $w.frames.step -textvar ::nucleicanalysor::step] -row 7 -column 5
    
    checkbutton $w.histogram -text "Histogram" -variable isChecked -offvalue 0 -onvalue 1 -command {if {$isChecked == 1} {
      ::nucleicanalysor::enableCommand 2
      } elseif {$isChecked == 0} {
        ::nucleicanalysor::enableCommand 3
      }}
...
#receive parameter b wich is the id of the dropdown list that called the Function
  #through binding 
proc ::nucleicanalysor::enableCommand {b} {
  variable w
  ...
  switch $b {
    ...
    2 {
      $w.nb.tab1.helix.distSel configure -command "::nucleicanalysor::Histogram {dist}"
      $w.nb.tab1.helix.angVal configure -command "::nucleicanalysor::Histogram {angl}"
      $w.nb.tab1.helix.distVal configure -command "::nucleicanalysor::Histogram {4dist}"
      $w.nb.tab1.helix.angleVal configure -command "::nucleicanalysor::Histogram {4angl}"
    }
    3 {
      $w.nb.tab1.helix.distSel configure -command "::nucleicanalysor::plotBases {dist}"
      $w.nb.tab1.helix.angVal configure -command "::nucleicanalysor::plotBases {angl}"
      $w.nb.tab1.helix.distVal configure -command "::nucleicanalysor::plotBases {4dist}"
      $w.nb.tab1.helix.angleVal configure -command "::nucleicanalysor::plotBases {4angl}"
    }
    default {
      puts "There's been a problem"
    }
  }
}
...
proc ::nucleicanalysor::trajectLoad {} {
...
proc ::nucleicanalysor::listeResname {} {
  ...
  foreach name $names  {
      ...
      if {![dict exist $selectList $rsn]} {
        dict set ::nucleicanalysor::selectList $rsn $rsi 
      } else {
        dict lappend ::nucleicanalysor::selectList $rsn $rsi 
      }
...
proc ::nucleicanalysor::selectWithResname {b} {
  variable w
  ...
  if {$name != ""} {
    ...
    dict for {id info} $::nucleicanalysor::selectList {
      if {$id eq $name} {
        set stc [split $info "\ "]
        break 
      }
...
proc ::nucleicanalysor::selectWithResid {b} {
  variable w 
  variable selectList
...
proc ::nucleicanalysor::matchList {} {
   #declaration of the global variable used (in order)
    #dictonary for the resname/resid 
    #window for the UI
    #max resid for the DNA contained
...
proc ::nucleicanalysor::plotBases { type {hist 0} } {
  ...
  if {$base1 ne "" && $match1 ne "" && $idBase1 ne "" && $idMatch1 ne ""} {
    ...
    if {$base2 eq ""} {
      ...
      if { $type eq "angl" } {
        ...
        set listP [::nucleicanalysor::computeFrames "angB" $res1 $res2 $res3 $res4]
      ...
      # Case if we want to plot a distance
        ...
        set listP [::nucleicanalysor::computeFrames "dist" $res1 $res2]
  ...
  if { $type eq "angl" } {
    ...
    set listP1 [::nucleicanalysor::computeFrames "angB" $res1 $res2 $res3 $res4]
    
    # Calling computeFrames on our selection for an angle between the two bases of the second selected pair
    set listP2 [::nucleicanalysor::computeFrames "angB" $res5 $res6 $res7 $res8]
  ...
  # Case if we want to plot a distance
    ...
    set listP1 [::nucleicanalysor::computeFrames "dist" $res1 $res2]
    
    # Calling computeFrames on our selection for a distance between the two bases of the second selected pair
    set listP2 [::nucleicanalysor::computeFrames "dist" $res3 $res4]
  ...
  # Case if we want to plot the angle difference between two pairs
    ...
    set listP [::nucleicanalysor::computeFrames "ang4" $res1 $res2 $res3 $res4 $res5 $res6 $res7 $res8]
  ...
  # Case if we want to plot the distance between two pairs
    ...
    set listP [::nucleicanalysor::computeFrames "dist4" $res1 $res2 $res3 $res4]
...
proc ::nucleicanalysor::computeFrames { type res1 res2 {res3 0} {res4 0} {res5 0} {res6 0} {res7 0} {res8 0} } {
...
proc nucleicanalysor::guaPlanForQuaAxis {} {
  global M_PI
  variable w
...
proc nucleicanalysor::twistAngle {} {
  global M_PI
  variable w
  variable numQuartets
  variable plotColors
...
proc nucleicanalysor::guaCoMDistances {} {
  global M_PI
  variable w
  variable nameAtomsGQuad
  variable mainQua
...
proc nucleicanalysor::gyrationRadii {} {
  variable w
  variable nameAtomsGQuad
  variable numQuartets
  variable plotColors
...
proc nucleicanalysor::guaAxisAngle {} {
  global M_PI
  variable w
  variable quaNum
  variable nameAtomsGQuad
...
proc nucleicanalysor_tk {} {
  ::nucleicanalysor::packageui
}
